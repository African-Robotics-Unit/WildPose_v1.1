...
public:
    ...
    {
        const rosbag2_cpp::StorageOptions storage_options({"wildpose_bag", "sqlite3"});
        ...
        writer_->create_topic({
            ...
            "sensor_msgs/msg/Image",  // type of data
            rmw_get_serialization_format(), // serialisation format
            ""  // QoS settings
        });
        ...
        subscription_ = create_subscription<std_msgs::msg::String>(
            "image_raw",    // topic name
            10,         // QoS
            std::bind(&SimpleBagRecorder::topic_callback, this, _1) // callback
        );
    }
